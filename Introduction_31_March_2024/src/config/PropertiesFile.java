...
public class PropertiesFile {
	...
	public static void readPropertiesFile() {
		...
		try {
			...
			InputStream input = new FileInputStream("/home/msr/eclipse-workspace/Introduction_31_March_2024/src/config/config.properties");
	...
	public static void writePropertiesFile() {
		...
		try {
			...
			OutputStream output = new FileOutputStream("/home/msr/eclipse-workspace/Introduction_31_March_2024/src/config/config.properties");
		// 3. Set values
